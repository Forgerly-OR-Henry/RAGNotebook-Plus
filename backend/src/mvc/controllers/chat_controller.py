...
from mvc.schemas import QueryRequest, RAGRequest, RAGResponse, ReorderRequest, ReorderResponse, SessionResponse
...
async def query_stream(
    ...
    return StreamingResponse(
        stream_agent_response(request.query, session_id, user_id),
