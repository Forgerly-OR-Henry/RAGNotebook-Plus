    ...
    async def upsert_documents(
        ...
        *,
        ...
        stmt = text(
            ...
            VALUES (:id, :source_type, :source_id, :user_id, :chunk_index, :content, CAST(:metadata AS jsonb), CAST(:embedding AS vector), :created_at, :updated_at)
    ...
    async def search(
        ...
        *,
        ...
        if source_ids:
            ...
            clauses.append(f"source_id IN ({', '.join(id_params)})")
